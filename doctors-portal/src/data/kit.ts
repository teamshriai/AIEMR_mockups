...
export const FACILITIES: Facility[] = [
  {
    id: 'SD-F-01',
    name: 'Indostates Whitefield, Bengaluru',
    code: 'AWF',
    beds: 620,
    role: 'hub',
...
export const PATIENTS: Patient[] = [
  ...
  },
  {
    ...
    sex: 'M',
    uhid: 'INS-0012774',
    scenario: 'Code stroke at Nashik spoke, LVO, drip-and-ship',
    payer: 'TPA cashless',
